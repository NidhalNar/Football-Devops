  ...
  new GoogleStrategy(
    {
      ...
      userprofilr:process.env.USER_PROFILEURL
    },
    async (accessToken, refreshToken, profile, done) => {
      try {
        ...
        if (!user) {
          ...
          sendConfirmationEmail(user.email, null, 'default', randomPassword);
        }
    ...
    switch (role) {
      ...
      case "player":
        roleSpecificAttributes = {
          ...
          teamAffiliation: req.body.teamAffiliation,
...
module.exports = { register, login, logout, confirmMail, getAdminDetails, verify ,forgotpwd};
